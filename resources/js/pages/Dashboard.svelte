...
<script lang="ts">
    ...
    let {
        ...
        activeDownloadLimitReached: boolean;
    ...
    $effect(() => {
        if (!prefillAutoSubmit || prefillSubmitted || !prefillUrl) {
            return;
        }
...
<div class="space-y-8">
    ...
    <section class="grid gap-6 lg:grid-cols-[22rem_minmax(0,1fr)]">
        ...
        >
            <TorrentSubmitForm
                downloadLimitReached={activeDownloadLimitReached}
